...
vim.cmd [[command! -nargs=* -range -bang -complete=file Prossesion lua require("packer.load")({'vim-obsession'}, { cmd = "Prossesion", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]]
